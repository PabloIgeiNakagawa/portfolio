...
function ButtonCode({ href }: ButtonProps) {
  return (
    <a
      ...
      className="group flex items-center gap-2 bg-transparent hover:bg-neutral-100 dark:hover:bg-neutral-800 font-texto text-neutral-800 dark:text-neutral-200 px-5 py-2.5 rounded-xl font-medium transition-all duration-300 border border-neutral-300 dark:border-neutral-600 hover:border-primary hover:shadow-md hover:shadow-primary/10 hover:-translate-y-0.5"
    >
